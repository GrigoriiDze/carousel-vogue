...
# --- ИНТЕРФЕЙС STREAMLIT ---
st.set_page_config(page_title="The генератор | Премиум", page_icon="⬛", layout="centered")

st.title("The генератор v2.1")
...
if btn_preview or btn_generate:
    if not uploaded_bgs:
        ...
        with st.spinner(status_text):
            ...
            # Если это превью — жестко обрезаем данные до 1 слайда
            if btn_preview:
            ...
            if btn_preview:
                ...
                # Показываем одну картинку по центру
